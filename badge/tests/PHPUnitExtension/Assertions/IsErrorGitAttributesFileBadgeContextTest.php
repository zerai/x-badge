...
/** @covers \Badge\Tests\PHPUnitExtension\Assertions\IsErrorGitAttributesFileBadgeContext */
final class IsErrorGitAttributesFileBadgeContextTest extends TestCase
{
    ...
    private IsErrorGitAttributesFileBadgeContext $constraint;

    protected function setUp(): void
    {
        $this->constraint = new IsErrorGitAttributesFileBadgeContext();
    }
