...
/** @covers \Badge\Tests\PHPUnitExtension\Assertions\IsUncommittedGitAttributesFileBadgeContext */
final class IsUncommittedGitAttributesFileBadgeContextTest extends TestCase
{
    ...
    private IsUncommittedGitAttributesFileBadgeContext $constraint;

    protected function setUp(): void
    {
        $this->constraint = new IsUncommittedGitAttributesFileBadgeContext();
    }
