...
namespace Badge\Tests\Support\ExtendedGithubClient\ApiMockServer;
...
class ApiMockServer
{
    ...
    public static function loadFixture(string $endpoint, string $jsonResponse): void
    {
        $expectetionTemplate = '
            {
                "httpRequest" : {
        ...
        $expectationDataRequest = trim(sprintf($expectetionTemplate, $endpoint, $jsonResponse));
