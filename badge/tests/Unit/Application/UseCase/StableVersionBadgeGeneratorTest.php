...
/** @covers \Badge\Core\Usecase\StableVersionBadgeGenerator */
final class StableVersionBadgeGeneratorTest extends TestCase
{
    ...
    private StableVersionBadgeGenerator $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new StableVersionBadgeGenerator($this->contextProducer, $this->imageFactory);
    }
